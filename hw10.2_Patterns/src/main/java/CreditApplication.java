/**
 Сделать кредитный конвейер, в который будут заходить объект “кредитная заявка” с какими-то параметрами и по какой-то
 логике-цепочке он будет проверять и принимать условие о выдаче и не выдаче той или иной суммы.
 */
