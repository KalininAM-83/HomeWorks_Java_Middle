...
/**
 Создать проект Автосервис, для учета технического обслуживания автомобилей на нашей СТО (Станция технического обслуживания).
Обязательно должно учитываться клиенты нашего сервиса (владельцы авто), автомобили и технические обслуживания.
Продемонстрировать в демо-классе:
Создание владельцев автомобилей
Создание автомобилей:
Назначение владельцев автомобилям
Первые заезды на техническое обслуживание:
Смена владельцев автомобилей:
Заезды на обслуживание с новыми владельцами:
Дополнительные заезды на обслуживание:
Список ТО по каждому автомобилю в формате
Стек: БД H2 или другая, чистый JPA или Hibernate, можно использовать JPQL
Spring не использовать
*/
